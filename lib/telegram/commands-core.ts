...
function helpText() {
  return [
    'دستیار مالک Smart Visions آماده است.',
    'می‌توانی فارسی معمولی بنویسی؛ دستیار ابتدا مسیر رایگان و قطعی را امتحان می‌کند و فقط برای درخواست مبهم از AI کم‌هزینه استفاده می‌کند.',
    '',
    'نمونه مکالمه:',
    '«الان چه چیز مهمی نیاز به توجه دارد؟»',
    '«چرا ارسال امروز کمتر از هدف بوده؟»',
    '«وضعیت Mailboxها و بودجه را توضیح بده.»',
    '',
    ...
    '',
    'هر تغییر قبل از اجرا Before → After و اثر آن را نشان می‌دهد و بدون تأیید انجام نمی‌شود.',
    'Secret، دورزدن DNC/Safety و فرمان خارج از رجیستری از تلگرام پذیرفته نمی‌شود.',
  ].join('\n');
}
