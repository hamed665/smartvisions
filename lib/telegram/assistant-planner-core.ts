...
const explicitMutation = /(کن|کنید|بکن|بذار|بگذار|تغییر|ویرایش|فعال|غیرفعال|روشن|خاموش|متوقف|ادامه|شروع|بساز|ایجاد|ارسال|بفرست|تأیید|تایید|رد|برگردان|حذف|set|change|update|enable|disable|pause|resume|start|create|send|approve|reject|revert|delete)/i;
